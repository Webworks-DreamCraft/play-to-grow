  ...
  <section className="md:bg-aboutBackground bg-auto md:bg-bottom">
    ...
    <section className="text-wheat-field-dark md:container mx-auto bg-[#F2FBEA]">
      ...
      <section className="lg:flex lg:items-center lg:text-left px-8 md:px-16 text-center pt-14 xl:pb-24 md:pt-16">
        <section className="">
          <h3 className="font-patua text-[28px] md:text-[36px] pt-8 md:pt-0">
            Katie Gonzalez
          </h3>
          <p className="font-prata text-lg py-6 lg:pr-28">
            Hello! I&apos;m Katie Gonzalez, the owner of Play to Grow and
            practicing Speech-Language Pathologist. I&apos;m incredibly
            passionate about making a meaningful difference in the lives of
            children with communication challenges. My educational journey began
            at the University of Florida, where I earned my undergraduate degree
            in Communication Sciences and Disorders. Building on this
            foundation, I pursued my Master of Science degree at the University
            of South Florida, further honing my skills and knowledge in the
            field. It was during this time that I developed a deep appreciation
            for the complexity of communication and the profound impact it has
      ...
      <section className="lg:flex lg:items-center lg:text-left px-8 md:px-16 text-center pt-4 xl:pb-24">
        <section className="">
          ...
          <p className="font-prata text-lg py-6 lg:pr-28">
            I&apos;m Erin! I was raised in Gainesville, received my
            undergraduate degree from the University of Florida, and my master’s
            degree from Florida State University. I have worked in a variety of
            settings, including schools and outpatient clinics, and have
            extensive experience supporting children with diverse communication
            profiles, including those with complex communication needs. With
            specialized training in AAC and gestalt language processing, my
            approach is rooted in compassionate collaboration, total
            communication, and neurodiversity-affirming practices. I am
            passionate about empowering caregivers to build confidence in
            supporting their child’s communication growth, celebrating each
            child’s unique strengths, and helping children express themselves in
            meaningful ways.
          </p>
        </section>
        <section className="flex justify-center lg:pl-2">
      ...
      <section className="lg:flex lg:items-center lg:text-left px-8 md:px-16 text-center pt-4 xl:pb-24">
        <section className="">
          ...
          <p className="font-prata text-lg py-6 lg:pr-28">
            Hey! I’m Amy, I’m a Speech Language Pathology Assistant (SLPA) here
            at Play to Grow. I graduated from the University of Florida (go
            gators!) with my bachelor’s in Communication Sciences and Disorders.
            I am passionate about and have experience working with high-tech
            AAC, kids with ASD, and the Natural Language Acquisition (NLA/GLP)
            frame-work. One of my priorities is incorporating
            neurodiversity-affirming practices, and I am always seeking to learn
            more. I look forward to growing with you!
          </p>
        </section>
        <section className="flex justify-center lg:pl-2">

        ...
        <section className="lg:grid-cols-2 lg:grid lg:items-center lg:text-left px-8 md:px-16 text-center pt-14 xl:pb-24 md:pt-16">
          <section className="">
            ...
            <p className="font-prata text-lg py-6 lg:pr-28">
              ​Play-based child-led therapy is a specialized approach we follow
              to address various emotional, behavioral, and developmental
              differences in children. This approach centers around the child's
              natural inclination to play and uses it as a medium for
        ...
        <section className="lg:flex lg:items-center lg:text-left px-8 md:px-16 text-center pt-14 xl:pb-24 md:pt-16">
          ...
          <section className="lg:pl-12">
            ...
            <p className="font-prata text-lg py-6">
              ...
              fundamental human right and seeks to provide, reinforce, and honor
              multiple means of communication. This includes, but is not limited
              to: verbalizations (words), vocalizations, gestures, sign
              language, augmentative and alternative communication (AAC), body

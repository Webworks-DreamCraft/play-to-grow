const IntakeFormInfo = () => (
  <section className="md:pr-8 text-lg font-prata">
    ...
    <p className="text-center md:text-start pb-9">
      Once you fill out the intake and contact form, I will reach out to you via
      email within 3-to-5 business days. From there, we can decide if Play to
      Grow is the right fit for your child.
    </p>
    <section className="hidden md:block">
      <section className="flex">
        ...
        <p className="pl-4 pb-4">katie@playtogrowgainesville.com</p>
      </section>
      <section className="flex">
        <svg
          width="24"
        ...
        <p className="pl-4">5200 Newberry Rd Suite E3, Gainesville FL 32607</p>
      </section>
    </section>
